    ...
    <div class=\"card-body\">
        ...
        echo "\" class=\"btn btn-sm btn-outline-secondary\">View</a>
            ...
            <small class=\"text-muted\">
                ";
        // line 19
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 19, $this->source); })()), "getReadingTimeInMinutes", [], "any", false, false, false, 19), "html", null, true);
        echo " min read
            </small>
...
";
    ...
    {
        return array (  74 => 19,  66 => 14,  57 => 9,  55 => 8,  49 => 5,  44 => 3,  40 => 1,);
    }
...
<div class=\"card shadow-sm\">
    ...
    <div class=\"card-body\">
        ...
        <div class=\"d-flex justify-content-between align-items-center\">
            ...
            <small class=\"text-muted\">
                {{ article.getReadingTimeInMinutes }} min read
            </small>
